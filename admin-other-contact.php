<?php
//****************************************************************************************
//* Name: admin-other-contact.php
//* Author: Joseph Garner
//* Date: 12/02/2024
//* Version: 1.03
//* Purpose: A form to edit the contactSentence in the database using Trumbowyg.
//****************************************************************************************
...
try {
    ...
    // Fetch the existing contactSentence
    $stmt = $pdo->prepare("SELECT contactSentence FROM contact LIMIT 1");
    $stmt->execute();
    $contact = $stmt->fetch(PDO::FETCH_ASSOC);

    // Content from database
    $existingContent = $contact ? $contact['contactSentence'] : "";
...
<head>
    ...
    <title>Edit Contact Sentence</title>
...
<div class="container mt-5">
    <h2>Edit Contact Sentence</h2>
    <form method="POST" action="admin-other-contact-action.php">
        <div class="mb-3">
            <label for="contactSentence" class="form-label">Contact Sentence</label>
            <!-- Trumbowyg replaces this textarea -->
            <textarea id="contactSentence" name="contactSentence"><?php echo htmlspecialchars($existingContent); ?></textarea>
        </div>
